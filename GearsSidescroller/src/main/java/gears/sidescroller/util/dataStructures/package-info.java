 ...
 * <li>Store a VolatileLinkedList<T>, henceforth referred to as "the list"</li>
 * <li>Items of type T which should be removed at some point must implement the Removable<T> interface</li>
